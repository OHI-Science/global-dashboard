...
* **front_page.R**: _Customize home page text and layout. Aesthetics are specified using CSS/HTML in the www folder_
...
* dataprep: _Prepare data for each goal to be plotted or mapped here. Each goal will have it's own script_
...
Each OHI goal `tabItem` can have a `tab_title_ui()`, `baseline_metrics_ui()`, `map_ui()`, and a `card_ui()`. I simplified the code so you can see all the individual elements. See outputs on the next page.
