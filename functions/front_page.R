      ...
      div(class = "box-con",
          ...
          tags$a(target = "_blank",
                 ...
                 div(class = "float box box-more",
                     tags$p(class = "intro-text", "The Basics"),
          ...
          tags$a(target = "_blank",
                 ...
                 div(class = "float box box-rear",
                     tags$p(class = "intro-text", "Find out more"),
                     tags$p("The Ocean Health Index Global Assessment is produced from a collaborative team of scientists based in Santa Barbara.") 
                     ))
          )
      )
